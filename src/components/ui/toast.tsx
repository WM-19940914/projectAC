...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-4 right-4 z-[9999] flex flex-col gap-2 md:max-w-[420px]",
      className
    )}
    {...props}
  />
